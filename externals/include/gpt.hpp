...
public:
	...
	class str {
		...
		static std::vector<std::string> split2(std::string in, char splitter);
	...
	class Math
	{
		...
		static Vector2 rotatePoint(Vector2 p, Vector2 c, float angle);
	...
	class phy
	{
		...
		public:
			GPT::Math::Vector	pos;
			GPT::Math::Vector	size;
			GPT::Math::Vector	angle;
			GPT::Math::Vector	momentum;
